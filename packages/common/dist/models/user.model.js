...
const user_abscract_1 = require("./user-abscract");
let UserDocument = class UserDocument extends user_abscract_1.default {
};
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], UserDocument.prototype, "postal_code", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
